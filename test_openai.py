    ...
    for i in range(len(payload)):
        ...
        messages=[
            {"role": "system", "content": f'I am doing an exam for a university level course at a technical university. \
             ...
             topic more than 1 time (serious but actually), make a new question from the content. Limit the use of define questions'},
            {"role": "user", "content": 'past exam: ' + past_exam},
            {"role": "user", "content": 'content: ' + payload[i]},
            {"role": "user", "content": 'asked questions: ' + str(response[-9:])},]
            ))
